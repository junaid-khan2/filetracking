            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card ">
                        ...
                        <form id="letterForm" action="{{ route('file.store.letter') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <fieldset class="border px-3">
                                    ...
                                    <div class="row">
                                        ...
                                        name="reference_no" id="reference_no_val" hidden  readonly>
                                        ...
                                        <div class="col-6" id="letter_no">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value="{{old('letter_no')}}" type="text" placeholder="Letter No" class="form-control @error('letter_no') is-invalid @enderror"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="input1">Received Date <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="input1">Nature Of Case <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="no_of_pages" class="form-control  @error('no_of_pages') is-invalid @enderror" aria-label="Default select example">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="dead_line" class="form-control  @error('dead_line') is-invalid @enderror" aria-label="Default select example">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="input1">Letter Date <span class="text-danger">*</span></label>

                                                <input type="date" value="{{date('Y-m-d')}}" class="form-control  @error('letter_date') is-invalid @enderror" name="letter_date" id="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="input1">From Department <span class="text-danger">*</span></label>

                                                <select name="from_section" class="form-control select2 @error('from_section') is-invalid @enderror"
                                                    ...
                                                    @foreach ($section as $item)
                                                        ...
                                                        @if ($item->id == Auth::user()->section || $item->code=="OTHER")

                                                        <option @if ($item->id == Auth::user()->section) selected @endif value="{{ $item->id }}">{{ $item->name }}</option>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="to_section" class="form-control select2 @error('to_section') is-invalid @enderror" id="to_section1"
                                                    ...
                                                    @if (!($item->in_out == "External" && $item->code == "OTHER"))
    ...
    <script>
        ...
        $('#letterForm').validate({
            ...
            messages: {
                ...
                from_section:{
                     required: "Please Select From Section"
                }
