            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form id="FileFrom" action="{{ route('file.store_file') }}" method="POST" enctype="multipart/form-data"

                            name="registration">

                            @csrf

                            <input type="hidden" class="form-control " name="reference_no" value="{{ $reference_no }}">
                                ...
                                <fieldset class="border px-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="input1">File Subject *</label>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="input1">Creation Date</label>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="input1">Select Letter/Reminder/NoteSheet/Reply</label>



                                                <select name="letter" class="form-control select2" id="">

                                                    <option value="">Select Letter</option>

                                                    @foreach ($letters as $item)

                                                    <option value="{{$item->id}}">{{$item->reference_no . " (".$item->file_type.")"}}</option>
        ...
        $(function() {
         ...
         $(document).ready(function() {
            ...
            messages: {
                ...
                letter: {
                    required: "Please Select The Letter For The File"
                },
                content: {
